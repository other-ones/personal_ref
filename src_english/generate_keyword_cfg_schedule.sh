...
accelerate launch --main_process_port 1986 --num_processes=1 --gpu_ids=4 --mixed_precision no  generate_rd_keyword_guided.py \
...
--local_rank=0 \
--resume_unet_ckpt_path='../weights/english/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME/unet_weight_s50001.pt' \
--output_dir="../generated/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME_s50K_NOSKIP_attnmod_pos05_neg0_suffix_seed7777" \
--eval_batch_size=1 \
--dbname="mario_eval2" \
--instance_data_root='/data/twkim/diffusion/ocr-dataset/' \
