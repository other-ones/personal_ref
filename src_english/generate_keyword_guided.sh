...
--lora_rank=32 --seed=7777 --guidance_scale=7.5 --treg_pos=0.5 --treg_neg=0.5  \
--include_suffix 


export PYTHONPATH=$PWD;
accelerate launch --main_process_port 1985 --num_processes=2 --gpu_ids=0,1 --mixed_precision no  generate_keyword_guided.py \
--pretrained_model_name_or_path="stabilityai/stable-diffusion-2-1" \
--use_xformers \
--local_rank=0 \
--resume_unet_ckpt_path='../weights/english/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME/unet_weight_s50001.pt' \
--output_dir="../generated/attn_mod_re/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME_s50K_NOSKIP_NOSUFFIX_attnmod_pos05_neg05_seed7777" \
--eval_batch_size=1 \
--dbname="mario_eval2" \
--instance_data_root='/data/twkim/diffusion/ocr-dataset/' \
