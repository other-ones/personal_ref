...
from custom_diffusers_v2 import (
    AutoencoderKL,
    DDPMScheduler,
    StableDiffusionPipeline,
    UNet2DConditionModel,
)
from custom_diffusers_v2.optimization import get_scheduler
...
def train(
    ...
    if enable_xformers_memory_efficient_attention:
        from custom_diffusers_v2.utils.import_utils import is_xformers_available
