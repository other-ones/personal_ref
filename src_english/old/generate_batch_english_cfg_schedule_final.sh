...
accelerate launch --main_process_port 9971 --num_processes=8 --gpu_ids=0,1,2,3,4,5,6,7 --mixed_precision no  generate_batch_english_cfg_schedule_final.py \
--pretrained_model_name_or_path="stabilityai/stable-diffusion-2-1" \
--use_xformers \
--local_rank=0 \
--resume_unet_ckpt_path='../weights/all/TRAIN_ALL_LAION2_MARIO1_LORA32_REC0025_SYNTH025/unet_weight_s50001.pt' \
--output_dir="../generated/english_all/MARIO_EVAL_ALL_50K_CFG_DEC05_BASE0P5_CONST7_ALLSET" \
--eval_batch_size=15 \
--dbname=mario_eval2 \
--lora_rank=32 \
