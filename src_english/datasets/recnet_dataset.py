...
import numpy as np
from rendering.official_rendering import font_devise_512
import torch
...
from rendering.official_rendering import render_text_image
import string
...
class OCRDataset(Dataset):
    ...
    def __init__(
            ...
            max_char_seq_length=100,
            max_word_len=25,
            max_num_words=64,
            roi_weight=1,
            font_path="fonts/GoNotoCurrent.ttf",
    ):
        ...
        for db in self.instance_data_list:
            self.per_db_count[db]=0
            caption_path = os.path.join(instance_data_root, db, 'mario_laion500K_ml_caption_ocr_test.txt')
    ...
    def __getitem__(self, index):
        ...
        example['fname']=img_file.split('.')[0]
        ...
        # """4. input_ids"""
        # # prompt input_ids
        # if self.tokenize_glyph:
        #     bog=self.placeholder_token1
        #     eog=self.placeholder_token2
        # else:
        #     bog="\""
        #     eog="\""
        ...
        example["instance_rendered_whole_image"] = rendered_whole_image
        example["instance_rendered_whole_image_rgb"] = rendered_whole_image_rgb
