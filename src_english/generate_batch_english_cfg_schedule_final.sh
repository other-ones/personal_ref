...
accelerate launch --main_process_port 9971 --num_processes=4 --gpu_ids=4,5,6,7 --mixed_precision no  generate_batch_english_cfg_schedule_final.py \
--pretrained_model_name_or_path="stabilityai/stable-diffusion-2-1" \
--use_xformers \
--local_rank=0 \
--resume_unet_ckpt_path='../weights/english/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME/unet_weight_s50001.pt' \
--output_dir="../generated/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME_CFG_DEC05_BASE1P5_CONST6_SUFFIX" \
--eval_batch_size=15 \
--dbname=mario_eval2 \
--lora_rank=32 \
...
export PYTHONPATH=$PWD;
accelerate launch --main_process_port 9971 --num_processes=3 --gpu_ids=0,1,2 --mixed_precision no  generate_batch_english_cfg_schedule_final.py \
--pretrained_model_name_or_path="stabilityai/stable-diffusion-2-1" \
--use_xformers \
--local_rank=0 \
--resume_unet_ckpt_path='../weights/english/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME/unet_weight_s50001.pt' \
--output_dir="../generated/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME_CFG_DEC05_BASE2P5_CONST5_NOSUFFIX" \
--eval_batch_size=15 \
--dbname=mario_eval2 \
--lora_rank=32 \
--instance_data_root='/data/twkim/diffusion/ocr-dataset/' \
...
export PYTHONPATH=$PWD;
accelerate launch --main_process_port 9972 --num_processes=3 --gpu_ids=5,6,7 --mixed_precision no  generate_batch_english_cfg_schedule_final.py \
--pretrained_model_name_or_path="stabilityai/stable-diffusion-2-1" \
--use_xformers \
--local_rank=0 \
--resume_unet_ckpt_path='../weights/english/LAIONFT_PEXEL8_L2_LORA32_SUFFIX_RECRESUME/unet_weight_s50001.pt' \
