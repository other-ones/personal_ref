...
db_list=['synth_pexel_thai3','synth_pexel_greek3','synth_pexel_hindi3',
         'synth_pexel_bengali3','synth_pexel_latin3','synth_pexel_russian3'
         ]#9-eng-german-french-italian+1 -> 6
dst_char_set=[]
...
dst_file=open('../ckpt/chartokenizer/char_vocab_mlt_all.json','w',encoding='utf-8')
