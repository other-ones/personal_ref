...
class OCRDatasetMLWeak(Dataset):
    """
    ...
    def __init__(
        ...
        if 'mario' in self.instance_data_list[0] and len(self.instance_data_list)==1:
            ...
            prob_map={
                    'icdar':0,
                    'synth_pexel_german':0,
                    'synth_pexel_italian':0,
                    'synth_pexel_french':0,
                    'synth_pexel_hindi':0.15,
                    'synth_pexel_bengali':0.35,
                    'synth_pexel_thai':0.35,
                    'synth_pexel_greek':0.075,
                    'synth_pexel_russian':0.075,
                }
            # prob_map={
            #         'icdar':0.3,
