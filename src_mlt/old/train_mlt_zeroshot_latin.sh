...
# Greek Unseen
export PYTHONPATH=/home/twkim/project/azure/refdiffuser/src_mlt;
accelerate launch --main_process_port 9912 --num_processes=1 --gpu_ids=0 --mixed_precision no  train_mlt.py \
--pretrained_model_name_or_path="stabilityai/stable-diffusion-2-1" \
--instance_data_root="/data/twkim/diffusion/ocr-dataset/" \
--output_dir="../saved_models/tmp_mlt" \
--train_batch_size=1 \
...
--synth_unet_loss_weight=0.01  \
--synth_ratio=0.5 \
--charset_path='ckpt/chartokenizer/char_vocab_mlt_latin.json' \
--lora_rank=32 
